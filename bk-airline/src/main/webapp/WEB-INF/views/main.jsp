...
<body>
   ...
   <div align="center" style="align-content: center; width: 100%; height: 100%;">
		<form class="searchsave" , method="post">
		 ...
		 background-color:#e3f2fd;  bordercolor: #e3f2fd; ">
       ...
       <table style="text-align: center; float:left;">
         ...
         <table style="text-align: center; float:left;">
         <tr><td>탑승 인원 수</td><th><input type="text"  name="people" placeholder="인원수" ></th></tr></table>   </td></tr></table> 
    	<table style="text-align: center; float:left;"><button type="button" class="btn btn-link btn-lg" >조회</button></table>
		 </form>
   </div>
