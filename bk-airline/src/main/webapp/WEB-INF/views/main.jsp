			...
			<div class="container">
				<div align="center" style="align-content: center; width: 100%; height: 100%;">
					<form class="searchsave" , method="post">
						...
						<table style="text-align: center; float:left;">
							<tr><td>가는날 선택</td><th><input type="date" placeholder="출발 날짜 선택"></th></tr>
						</table>
						<table style="text-align: center; float:left;">
							<tr><td>오는날 선택</td><th><input type="date" placeholder="도착 날짜 선택"></th></tr>
						</table>
						<table style="text-align: center; float:left;">
							<tr><td>탑승 인원 수</td><th><input type="text"  name="people" placeholder="인원수" ></th></tr>
						</table>
