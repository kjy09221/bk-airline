			 ...
			 <div class="scroll-body filter-body">
                  <ul id="schedule0List">
                    <li class="">
                      ...
                      <div class="t7 last align-right" OnClick="location.href ='sing'" style="cursor:pointer;"><span class="charge-status"><span class="status ">요금확정 </span><span class="charge-badge status1 ">가능</span></span> <span class="charge"><strong>795,000</strong>원</span></div>
